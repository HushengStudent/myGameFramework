...
public class UnityEngine_RendererWrap
{
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Renderer.HasPropertyBlock");
#endif
		try
		{
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Renderer.GetMaterials");
#endif
		try
		{
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Renderer.GetSharedMaterials");
#endif
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Renderer.forceRenderingOff");
#endif
		object o = null;
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Renderer.renderingLayerMask");
#endif
		object o = null;
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Renderer.rendererPriority");
#endif
		object o = null;
