...
public class LuaInterface_LuaInjectionStationWrap
{
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("LuaInterface.LuaInjectionStation.ctor");
#endif
		try
		{
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("LuaInterface.LuaInjectionStation.CacheInjectFunction");
#endif
		try
		{
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("LuaInterface.LuaInjectionStation.Clear");
#endif
		try
		{
