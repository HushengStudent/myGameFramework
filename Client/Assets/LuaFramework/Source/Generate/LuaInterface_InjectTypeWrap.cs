...
public class LuaInterface_InjectTypeWrap
{
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("LuaInterface.InjectType.None");
#endif
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("LuaInterface.InjectType.After");
#endif
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("LuaInterface.InjectType.Before");
#endif
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("LuaInterface.InjectType.Replace");
#endif
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("LuaInterface.InjectType.ReplaceWithPreInvokeBase");
#endif
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("LuaInterface.InjectType.ReplaceWithPostInvokeBase");
#endif
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("LuaInterface.InjectType.IntToEnum");
#endif
