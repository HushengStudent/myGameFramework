...
public class UnityEngine_CameraWrap
{
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Camera.Reset");
#endif
		try
		{
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Camera.GetGateFittedFieldOfView");
#endif
		try
		{
			ToLua.CheckArgsCount(L, 1);
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Camera.GetGateFittedLensShift");
#endif
		try
		{
			ToLua.CheckArgsCount(L, 1);
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Camera.FocalLengthToFieldOfView");
#endif
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Camera.FieldOfViewToFocalLength");
#endif
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Camera.HorizontalToVerticalFieldOfView");
#endif
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Camera.VerticalToHorizontalFieldOfView");
#endif
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Camera.AddCommandBufferAsync");
#endif
		try
		{
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Camera.overrideSceneCullingMask");
#endif
		object o = null;
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Camera.usePhysicalProperties");
#endif
		object o = null;
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Camera.sensorSize");
#endif
		object o = null;
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Camera.lensShift");
#endif
		object o = null;
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Camera.focalLength");
#endif
		object o = null;
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Camera.gateFit");
#endif
		object o = null;
