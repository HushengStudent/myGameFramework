...
public class Framework_LuaBuffWrap
{
	...
	{
		L.BeginClass(typeof(Framework.LuaBuff), typeof(System.Object));
	...
	static int _CreateFramework_LuaBuff(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				Framework.LuaBuff obj = new Framework.LuaBuff();
			...
			else if (count == 1)
			{
				...
				Framework.LuaBuff obj = new Framework.LuaBuff(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
	...
	static int Close(IntPtr L)
	{
		try
		{
			...
			Framework.LuaBuff obj = (Framework.LuaBuff)ToLua.CheckObject<Framework.LuaBuff>(L, 1);
			obj.Close();
			return 0;
		}
		catch (Exception e)
