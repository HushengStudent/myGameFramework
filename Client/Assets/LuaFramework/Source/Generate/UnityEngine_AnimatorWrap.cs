...
public class UnityEngine_AnimatorWrap
{
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Animator.WriteDefaultValues");
#endif
		try
		{
	...
	{
#if UNITY_EDITOR
        ToluaProfiler.AddCallRecord("UnityEngine.Animator.keepAnimatorControllerStateOnDisable");
#endif
		object o = null;
