    ...
    public class AssetBundleMgr : Singleton<AssetBundleMgr>
    {
        ...
        private AssetBundle MainAssetBundle
        {
            get
            {
                ...
                {
                    Debug.LogError(string.Format("[AssetBundleMgr]Load AssetBundle {0} failure!", FilePathUtility.AssetBundlePath + "AssetBundle"));
                }
        ...
        private AssetBundleManifest Manifest
        {
            get
            {
                ...
                if (manifest == null)
                {
                    Debug.LogError(string.Format("[AssetBundleMgr]Load AssetBundleManifest {0} failure!", FilePathUtility.AssetBundlePath + "AssetBundle"));
                }
                return manifest;
            }
        }
