    ...
    public partial class DebugMgr
    {
        public class DebugSelect
        {
            public void DrawSelect(int windowId)
            {
                ...
                {
                    DebugMgr.Instance.SetShowType(ShowType.ShowNon);
                }
            }
        }
    }
