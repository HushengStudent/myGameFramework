...
Shader "FastShadowProjector/FSP_TerrainFirstPass" { 
	Properties { 
	...
	Dependency "AddPassShader" = "FastShadowProjector/FSP_TerrainAddPass"
	Dependency "BaseMapShader" = "FastShadowProjector/FSP_TerrainBaseMap"
}